...
namespace Backend
{
    ...
    public:
         ...
         */
        virtual void Save(const std::vector<std::shared_ptr<Entry>> & entries, const std::wstring & identifier) = 0;
         ...
         */
        virtual std::vector<std::shared_ptr<Entry>> Load(const std::wstring & identifier) = 0;
    };
}
